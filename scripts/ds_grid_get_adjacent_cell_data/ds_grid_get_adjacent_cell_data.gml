...
function ds_grid_get_adjacent_cell_data(_grid, _x, _y, _value){
	...
	var _arr = [_cell_left, _cell_right,_cell_above, _cell_below, _cell_above_left, _cell_above_right, _cell_below_left, _cell_below_right]
